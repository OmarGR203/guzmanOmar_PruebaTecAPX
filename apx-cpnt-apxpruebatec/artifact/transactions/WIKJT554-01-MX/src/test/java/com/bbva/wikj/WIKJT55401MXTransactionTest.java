...
/**
 * Test for transaction WIKJT55401MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT55401MXTest.xml" })
public class WIKJT55401MXTransactionTest {

	@Autowired
	private WIKJT55401MXTransaction transaction;
